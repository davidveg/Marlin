...
#define HOMING_BUMP_DIVISOR { 15, 15, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 * the required CS pins in your `pins_MYBOARD.h` file. (e.g., RAMPSx 1.4 uses AUX3
